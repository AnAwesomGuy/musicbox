...
public class MusicBoxRenderer implements BlockEntityRenderer<MusicBoxBlockEntity> {
    ...
    public static final SpriteIdentifier MUSIC_BOX_TEXTURE = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, WindupMusicBoxMod.id("block/music_box"));
    ...
    public void render(MusicBoxBlockEntity entity, float tickProgress, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay, Vec3d cameraPos) {
        model.update(entity);
        VertexConsumer vertexConsumer = MUSIC_BOX_TEXTURE.getVertexConsumer(vertexConsumers, RenderLayer::getEntitySolid);
